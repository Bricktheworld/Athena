...
//        result += float4(weight, 0.0f, 0.0f, weight);
    ...
    // Some experimentally determined gamma that makes things more pleasing during lighting changes?
    // It also makes things brighter so I don't really know what it does...
