...
// TODO(bshihabi): I'd like to unify this code a lot more with the shader code, but
// there are a couple of HLSL things I haven't implemented cpp side so this is how I'm doing it for now.
// These are basically so I just know the size of the SH and can use it in interop with c++ code
template <typename T, s32 N, s32 L>
struct SH
{
...
using L1 = L1_Generic<f32, 1>;
using L1_F16 = L1_Generic<f16, 1>;
using L1_RGB = L1_Generic<f32, 3>;
using L1_F16_RGB = L1_Generic<f16, 3>;

template<typename T, int32_t N = 1> using L2_Generic = SH<T, N, 2>;
using L2 = L2_Generic<f32, 1>;
using L2_F16 = L2_Generic<f16, 1>;
using L2_RGB = L2_Generic<f32, 3>;
using L2_F16_RGB = L2_Generic<f16, 3>;
#else
