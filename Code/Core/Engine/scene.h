...
struct SceneObj
{
  ...
  // 
  AssetId model_asset  = kNullAssetId;
  u32     subset_id    = 0;
  u32     mat_id       = 0;
  u32     gpu_id       = 0;
...
SceneObjHandle          init_render_scene_obj(AssetId model, u32 subset, u32 flags = 0);
...
void                    dynamic_scene_obj_attach_render_model(SceneObjHandle handle, AssetId model, u32 subset);
