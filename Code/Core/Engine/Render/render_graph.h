...
{
  DescriptorLinearAllocator     cbv_srv_uav_table;
...
struct RenderGraph
{
  ...
  GpuDescriptor                        grv_descriptors[kGrvCount];
  GpuDescriptor                        grv_temporal_descriptors[kGrvTemporalCount * kBackBufferCount];
