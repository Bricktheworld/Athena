...
FOUNDATION_API void* push_memory_arena_aligned(MEMORY_ARENA_PARAM, size_t size, size_t alignment = 1);
...
FOUNDATION_API MemoryArena sub_alloc_memory_arena(MEMORY_ARENA_PARAM, size_t size, size_t alignment = 1);
